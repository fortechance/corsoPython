...
axs[0].text(0.5, 0.5, f'{totale2021}$', horizontalalignment='center', verticalalignment='center', fontsize=16, weight='bold')
...
axs[1].text(0.5, 0.5, f'{totale2022}$', horizontalalignment='center', verticalalignment='center', fontsize=16, weight='bold')
...
axs[2].text(0.5, 0.5, f'{totale2023}$', horizontalalignment='center', verticalalignment='center', fontsize=16, weight='bold')
